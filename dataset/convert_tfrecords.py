...
'''How to organize your dataset folder:
  VOCROOT/
       ...
       |    |->...
'''
tf.app.flags.DEFINE_string('dataset_directory', '/home/weiwei/DATASETS/VOCROOT',
                           'All datas directory')
tf.app.flags.DEFINE_string('train_splits', 'VOC2007',
                           'Comma-separated list of the training data sub-directory')
tf.app.flags.DEFINE_string('validation_splits', 'VOC2012TEST',
                           'Comma-separated list of the validation data sub-directory')
tf.app.flags.DEFINE_string('output_directory', '/home/weiwei/zoomlion_code/SSD.TensorFlow/dataset/tfrecords',
